defmodule Arc.Definition.Storage do
  defmacro __using__(_) do
    quote do
      ...
      def bucket(_), do: Application.fetch_env!(:arc, :bucket)
      ...
      defoverridable [storage_dir: 2, filename: 2, validate: 1, default_url: 1, default_url: 2, __storage: 0, bucket: 1, config_overrides: 1]
